...
FROM "Compendium/Atlas/Le Continent/Saint Empire de Ravia/Royaume de Ravia"
WHERE type= "landmark"
SORT file.name ASC
...
>```dataview
LIST WITHOUT ID headerLink
FROM "Compendium/Lore/Events" AND [[Royaume de Ravia]]
...
>```dataview
LIST WITHOUT ID headerLink
FROM "Session Notes" AND [[Royaume de Ravia]]
SORT file.ctime DESC
