...
FROM "Compendium/Atlas/Le Continent/Saint-Empire de Ravia/Forêt d'Arsuri"
WHERE type= "landmark"
SORT file.name ASC
...
>```dataview
LIST WITHOUT ID headerLink
FROM "Compendium/Lore/Events" AND [[Forêt d'Arsuri]]
...
>```dataview
LIST WITHOUT ID headerLink
FROM "Session Notes" AND [[Forêt d'Arsuri]]
SORT file.ctime DESC
